...
### Створення користувача GitHub (UserGitHubSignIn)
| **ID**                | `UserGitHubSignIn` |
|-----------------------|--------------------|
...
### Редагування даних користувача (EditUser)
...
### Створення проекту (CreateProject)
...
### Редагування проекту (EditProject)
...
### Видалення проекту (DeleteProject)
...
### Додавання учасника до проекту (AddMemberToProject)
...
### Видалення учасника з проекту (RemoveMemberFromProject)
...
Duallo — це інструмент управління проектами, який спрощує створення проектів будь-якого масштабу. Він надає функції, що полегшують розробку проектів, ефективно організовуючи процеси їх керування.

Основні категорії користувачів системи:

- **Project Manager (PM, тімлід)**: Відповідає за планування, організацію та керування проектом. Адмініструє СУП та координує роботу всіх учасників проекту.
- **Команда розробників**: Фахівці, які працюють над виконанням конкретних завдань у проекті. Використовують СУП для відстеження завдань, внесення звітів та спілкування з іншими учасниками.
- **Замовник**: Особа або організація, яка ініціювала проект і визначає його вимоги та цілі. Використовує СУП для моніторингу прогресу та забезпечення відповідності проекту потребам.
- **Аналітики та керівництво**: Використовують СУП для аналізу продуктивності проекту, прийняття рішень та розробки стратегій.
- **Користувачі проекту**: Особи, які користуються результатами проекту (зацікавлені сторони).

Duallo допомагає ефективно керувати проектами, забезпечуючи прозорість, контроль та комунікацію між усіма учасниками.
